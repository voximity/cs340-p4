...
// int nums[] = {9, 5, 1, 13, 17, 2, 6, 7, 8, 3, 4, 10, 18, 11, 12, 14, 19, 15,
// 16, 20};
// int len = nums.length;
...
// 10);
// sFields[1] = Arrays.copyOf((new Integer(nums[i])).toString().toCharArray(),
// 15);
...
// public void test4(String s, int nums[], int blockSize, int max) throws
// IOException {
...
// sFields[1] = Arrays.copyOf((new Integer(nums[i])).toString().toCharArray(),
// 15);
// sFields[2] = Arrays.copyOf((new Integer(nums[i])).toString().toCharArray(),
// 25);
...
// if (s4a.size() == 0) System.out.println("No items found in range "+1+"
// "+max);
// else {
...
// if (s4a.size() == 0) System.out.println("No items found in range "+max/8+"
// "+max/4);
// else {
// for (int j = 0; j < s4a.size(); j++) {
// s4 = s4a.get(j);
...
// sFields[2] = Arrays.copyOf((new Integer(nums[i])).toString().toCharArray(),
// 20);
// sFields[3] = Arrays.copyOf((new Integer(nums[i])).toString().toCharArray(),
// 30);
